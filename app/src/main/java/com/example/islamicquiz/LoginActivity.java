...
public class LoginActivity extends AppCompatActivity {
    ...
    private void linkAccountToAdminProfile(String email) {
        ...
        db.collection("users")
            .whereEqualTo("email", email)
            .whereEqualTo("role", com.example.islamicquiz.model.UserRole.ADMIN.name())
            .get()
            .addOnSuccessListener(queryDocumentSnapshots -> {
                if (!queryDocumentSnapshots.isEmpty()) {
                    ...
                    try {
                        com.example.islamicquiz.model.User user = document.toObject(com.example.islamicquiz.model.User.class);
                        user.setId(document.getId());
    ...
    private void createNewAdminProfile(String email) {
        com.example.islamicquiz.model.User adminUser = new com.example.islamicquiz.model.User(
            "admin_" + System.currentTimeMillis(),
            email,
            "مدير النظام",
            com.example.islamicquiz.model.UserRole.ADMIN
        );
    ...
    /**
     * تشغيل التشخيص التلقائي عند تسجيل الدخول
     */
    private void runAutoDiagnostic() {
        Log.d(TAG, "Running automatic system diagnostic after login...");
        ...
        FirebaseAuthDiagnostic.runDiagnostic(this, new FirebaseAuthDiagnostic.DiagnosticCallback() {
            ...
            public void onResult(String diagnosis, String recommendation) {
                // عرض نتيجة التشخيص تلقائياً
                Log.d(TAG, "Diagnostic result: " + diagnosis);
                ...
                new android.app.AlertDialog.Builder(LoginActivity.this)
                        ...
                        .setNeutralButton("معلومات Firebase", (dialog, which) -> {
                            FirebaseAuthDiagnostic.showFirebaseInfo(LoginActivity.this);
                        })
                        .show();
            }
            ...
            public void onError(String error) {
                Log.e(TAG, "Diagnostic error: " + error);
