...
public class CustomerDetailsDialog extends DialogFragment implements AddPaymentDialog.OnPaymentAddedListener {
    ...
    private void loadCustomerDetails() {
        ...
        DocumentReference customerRef = db
    ...
    private void showInvoiceDetails(Invoice invoice) {
        ...
        // على سبيل المثال:
        //InvoiceDetailsDialog dialog = InvoiceDetailsDialog.newInstance(invoice);
        //dialog.show(getChildFragmentManager(), "InvoiceDetailsDialog");
        
        // أو يمكنك فقط عرض رسالة قصيرة للتأكيد على أن النقر يعمل
